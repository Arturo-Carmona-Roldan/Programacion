        ...
        do {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    if (!ok)
                        System.out.println("No existe ese código de reparación");
                    break;
                case 3:
                    System.out.print("Codigo reparación: ");
                    cod = teclado.next();
                    ...
                    if (!ok)
                        System.out.println("No existe ese código de reparación o ya presupuestado");
                    break;
                case 4:
                    System.out.print("Codigo reparación: ");
                    cod = teclado.next();
                    ...
                    if (!ok)
                        System.out.println("No existe ese código de reparación o no aceptado presupuesto");
                    break;
                case 5:
                    System.out.print("Codigo reparación: ");
                    cod = teclado.next();
                    ...
                    if (!ok)
                        System.out.println("No existe ese código de reparación o no reparado aún");
                    break;
                case 6:
                    Taller.listar();
                    break;
