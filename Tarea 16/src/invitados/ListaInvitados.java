...
public class ListaInvitados {
    ...
    public Invitado getDatos() {
        //crea una plantilla (llamada pat) de como debe de ser el dato a introducir
        Pattern pat = Pattern.compile("\\d{8}(?i)[A-HJ-NP-TV-Z]");
        //compara el texto dado con la plantilla
        Matcher mat;
        boolean ok;
        ...
        do {
            ...
            dni = teclado.next();
            //compara el texto dni con la plantilla(pat)
            mat = pat.matcher(dni);
            //mat.find no mira si el dni es valido, mira si en el texto dni encaja con la plantilla
